...
- **Delete `expense-buddy-sms-import` Expo module**: Removed `ExpenseBuddySmsImportModule.kt`, all TypeScript bridge files, `expo-module.config.json`, and `expo-module-gradle-plugin` — sms-import is now a pure Kotlin library with no JS bridge
