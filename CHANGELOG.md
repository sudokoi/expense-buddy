...
- [`0e479d7`](https://github.com/sudokoi/expense-buddy/commit/0e479d7a7e34228e95af2e1de3977ad9276df66c) Thanks [@sudokoi](https://github.com/sudokoi)! - Improve visual consistency across SMS review and shared controls

  - Clarify secondary actions and picker fields with themed outlines.
  - Align SMS amount entry and keyboard-pinned actions with Add/Edit, and clean up payment labels and placeholders.
  - Improve update-banner readability and touch targets, and add selection checkmarks while retaining subtle theme-choice fills.
  - Update storage documentation to reflect MMKV, Android SecureStore, and native Room persistence.
...
- [#133](https://github.com/sudokoi/expense-buddy/pull/133) [`def2254`](https://github.com/sudokoi/expense-buddy/commit/def2254e85a22af022e8099370012277aaa10fd8) Thanks [@sudokoi](https://github.com/sudokoi)! - Polish Android UI, performance, and build reliability
...
- [#125](https://github.com/sudokoi/expense-buddy/pull/125) [`08816a5`](https://github.com/sudokoi/expense-buddy/commit/08816a5221b46fe4c3d2daf535ffef02625490ed) Thanks [@sudokoi](https://github.com/sudokoi)! - Add Canada and Australia support with region-aware SMS import
...
- [#106](https://github.com/sudokoi/expense-buddy/pull/106) [`7ba8562`](https://github.com/sudokoi/expense-buddy/commit/7ba8562783a9b925ec3899a1fe846a680be9c0c2) Thanks [@sudokoi](https://github.com/sudokoi)! - Refactor internals to deepen modules and narrow interfaces with no user-facing
  behavior change:
...
- [`987e502`](https://github.com/sudokoi/expense-buddy/commit/987e50209cdbd96904006a67cf225c715cdb5a48) Thanks [@sudokoi](https://github.com/sudokoi)! - Fix SMS notification deep link, i18n bugs, and code quality improvements
...
- [#101](https://github.com/sudokoi/expense-buddy/pull/101) [`afcef3d`](https://github.com/sudokoi/expense-buddy/commit/afcef3d8a70a4323cd2c67ae25e549e234ad3cdc) Thanks [@sudokoi](https://github.com/sudokoi)! - Fix the analytics stats cards hiding the "of ₹X" subtext when only a time filter (e.g. "Last 1 month") was active. The subtext is now shown whenever any filter is active and the headline is scoped below the full-period total — the full-period total is the all-time grand total for the currency, ignoring every filter including the time window. The subtext only disappears in the default/reset state (no active filters).

## 3.9.0

### Minor Changes

- [#99](https://github.com/sudokoi/expense-buddy/pull/99) [`d498725`](https://github.com/sudokoi/expense-buddy/commit/d498725585d4dc86b315f457cd16aeb624de9a42) Thanks [@sudokoi](https://github.com/sudokoi)! - Remove the Dashboard tab and make Analytics the default (first) tab, consolidating the old dashboard's overview into the analytics page.
...
- [#91](https://github.com/sudokoi/expense-buddy/pull/91) [`4b8f623`](https://github.com/sudokoi/expense-buddy/commit/4b8f6231b2c839798be2e8ebde1e7223eea45556) Thanks [@sudokoi](https://github.com/sudokoi)! - Unified the History and Analytics filters into one shared filter screen with app-wide currency selection
...
- [#82](https://github.com/sudokoi/expense-buddy/pull/82) [`1550627`](https://github.com/sudokoi/expense-buddy/commit/15506278f4da5807dcf8ef97f1bbb0c174e4b21b) Thanks [@sudokoi](https://github.com/sudokoi)! - UI and storage improvements
...
- [#69](https://github.com/sudokoi/expense-buddy/pull/69) [`cdb5179`](https://github.com/sudokoi/expense-buddy/commit/cdb517976a567945bdf9a75a6659f0ac69f6ce9f) Thanks [@sudokoi](https://github.com/sudokoi)! - - **Zero-hop SMS architecture**: Delete JS bridge files for sms-import, move `SmsImportReviewProvider` to `providers/`, add `SkipReason` diagnostics and combining-marks stripping for mathematical sans-serif Unicode
...
- [#65](https://github.com/sudokoi/expense-buddy/pull/65) [`590d234`](https://github.com/sudokoi/expense-buddy/commit/590d234360e1124777e5ae46684b08071758202a) Thanks [@sudokoi](https://github.com/sudokoi)! - Upgrade Tamagui from v1 to v2 and migrate all component APIs to v5 shorthands.
...
- [#45](https://github.com/sudokoi/expense-buddy/pull/45) [`1ffdd1e`](https://github.com/sudokoi/expense-buddy/commit/1ffdd1e1f4748e14a8242214c5c175f5314cd757) Thanks [@sudokoi](https://github.com/sudokoi)! - Add a configurable math-entry mode for expense amounts and reorganize the settings screen.
