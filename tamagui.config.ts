...
export const config = createTamagui({
  ...
  tokens: {
    ...
    color: {
      ...
      expenseRedLight: THEME_COLORS.expenseRedLight,
      incomeGreen: SEMANTIC_COLORS.success,
      incomeGreenLight: THEME_COLORS.incomeGreenLight,
  ...
  themes: {
    ...
    light: {
      ...
      backgroundPress: THEME_COLORS.lightBackgroundPress,
      backgroundFocus: THEME_COLORS.kawaiiSoftWhite,
      color: THEME_COLORS.kawaiiSoftDark,
      colorHover: THEME_COLORS.lightColorHover,
      colorPress: THEME_COLORS.lightColorPress,
      colorFocus: THEME_COLORS.kawaiiSoftDark,
      borderColor: THEME_COLORS.kawaiiLavender,
      borderColorHover: THEME_COLORS.lightBorderHover,
      borderColorFocus: THEME_COLORS.kawaiiPink,
      borderColorPress: THEME_COLORS.lightBorderPress,
      placeholderColor: THEME_COLORS.lightPlaceholder,
    },
    dark: {
      ...defaultConfig.themes.dark,
      background: THEME_COLORS.kawaiiDarkPurple,
      backgroundHover: THEME_COLORS.kawaiiDarkCard,
      backgroundPress: THEME_COLORS.darkBackgroundPress,
      backgroundFocus: THEME_COLORS.kawaiiDarkCard,
      color: THEME_COLORS.kawaiiSoftLight,
      colorHover: NEUTRAL_COLORS.white,
      colorPress: THEME_COLORS.darkColorPress,
      colorFocus: THEME_COLORS.kawaiiSoftLight,
      borderColor: THEME_COLORS.darkBorderColor,
      borderColorHover: THEME_COLORS.darkBorderHover,
      borderColorFocus: THEME_COLORS.darkBorderFocus,
      borderColorPress: THEME_COLORS.darkBorderPress,
