...
class SeedLiteRtEmbeddingHybridPredictor:
    ...
    def predict_record(self, record: NormalizedSmsRecord):
        ...
        return baseline_prediction.__class__(
            predictor_name="seed-litert-embed-hybrid",
...
def main() -> None:
    ...
    report = evaluate_records(records, SeedLiteRtEmbeddingHybridPredictor(model_path))
    output_path = artifacts_dir / "seed-v1-litert-embed-hybrid.json"
