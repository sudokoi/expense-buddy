...
object UkSmsRulePack : SmsRulePack {
    ...
    override val categoryInferenceRules =
        listOf(
            "Food" to
                Regex(
                    "greggs|pret|mcdonald(?:['’]?s)?|nando|restaurant|cafe|coffee|pizza|burger|dining|eatery|bakery|food|uber eats|just eat|deliveroo|subway|dominos|wetherspoon|pub",
                    RegexOption.IGNORE_CASE,
                ),
            "Groceries" to
                Regex(
